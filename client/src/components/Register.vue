  ...
  <!-- <div class="container-fluid">
          ...
          <div class="col-xs-12">
            <h2><i class="fa fa-pencil"></i> REGISTER</h2>
              <div class="ms-field">
                ...
                <input v-model="register.username" type="text" class="field" />
              ...
              <div class="ms-field">
                <label>Name</label>
                <input v-model="register.name" type="text" class="field" />
                <label class="placeholder">Password</label>
                <div class="ms-line"><i class="fa fa-check"></i></div>              
              </div>
              <button type="button" v-on:click.prevent="registerUser()" class="ms-form-btn" >SUBMIT</button>
    ...
    <div  class="alert alert-dismissible alert-success">
      ...
      <div class="form-group">
        ...
        <input v-model="register.name" type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter Your Name">
        <!-- <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small> -->
      </div>      
      <div class="form-group">
        <label for="exampleInputEmail1">Email</label>
        <input v-model="register.email"  type="email" class="form-control" id="exampleInputEmail1" placeholder="Email">
      </div>
      <div class="form-group">
        <label for="exampleInputPhone1">Phone</label>
        <input v-model="register.phone" type="text" class="form-control" id="exampleInputPhone1" placeholder="Phone">
      </div>
      <div class="form-group">
        <label for="exampleInputAddress1">Address</label>
        <input v-model="register.address" type="text" class="form-control" id="exampleInputAddress1" placeholder="Address">
      </div>
      <div class="form-group">
        <label for="exampleInputPassword1">Password</label>
        <input v-model="register.password" type="text" class="form-control" id="exampleInputPassword1" placeholder="Password">
      </div>
      <div class="form-group">
        <label for="exampleInputPassword1">Username</label>
        <input v-model="register.username" type="text" class="form-control" id="exampleInputUsername1" placeholder="Username">
      </div>
      <button type="submit" v-on:click="registerUser()" class="btn btn-warning">Submit</button>
    </div>
